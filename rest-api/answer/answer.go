...
var Answer = []string{
	...
	"DNS",
	"Service Dicovery",
	"Whatever the hell an Istio might be",
	"An AWS service with more syllables than engineers",
	"Your résumé",
	"Copying and pasting from Stack Overflow",
	"A Short Stack Developer",
	"A technical preview that only works on Kelsey Hightower's laptop",
	"An endless field of service meesh",
	"An elaborate prank called the CNCF",
	"A conference talk full of lies",
	"A vendor named with leftover Scrabble tiles",
	"Describing ':wq' as a 'container escape'",
	"A new definition of microservice",
	"A connection request from someone you don't know on LinkedIn",
	"Shooting a Nerf gun at your boss",
	"Admin rights",
	"ALT + F4",
	"646 Chrome Tabs",
	"Command + CTRL + Q",
